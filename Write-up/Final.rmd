...
Displayed below (and the next page) are the choropleth maps for both the logistic regression model and the random forest with the scaled difference statistic. 
