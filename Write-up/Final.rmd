...
modForest <- randomForest(DriverDrinking ~ Sex + Age + PrevSuspensions + 
                          PrevDWIConvictions + NumFatalities + WeekdayStatus + 
                          DayStatus + IncomeToPovRatio + TotalPopulation, 
...
Random forest model was assessed with accuracy validated through cross-validation. K value of 20 was specified in cross-validation, indicating that the data was split in a test and training set 20 times and accuracy was calculated each time, producing an aggregate estimate of accuracy of about 0.80. Again, given the noisiness in the data, a 0.80 accuracy shows that our random forest performs very well. The logistic regression model and the random forest are about the same in terms of accuracy.
